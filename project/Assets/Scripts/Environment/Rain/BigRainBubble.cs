...
public class BigRainBubble : RainBubble
{
    ...
    {
        playerController = _other.gameObject.GetComponent<PlayerController>();
        ...
        StartCoroutine(StopRainBubbleAddSpeedDelay(2f));
    ...
    /// <returns></returns>
    public IEnumerator StopRainBubbleAddSpeedDelay(float delayTime)
    {
