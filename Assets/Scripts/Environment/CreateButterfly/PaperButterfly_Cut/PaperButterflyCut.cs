...
public class PaperButterflyCut : MonoBehaviour
{
    ...
    {
        GameObject obj = GameObject.Instantiate(Resources.Load("Prefab/PaperButterfly_Alive/PaperButterfly_Alive")) as GameObject;

        obj.transform.position = this.transform.position;
        //销毁自己的时候激活DarkZone
        EventMgr.GetInstance().EventTrigger<string>("OpenDarkZone", "OpenDarkZone");
